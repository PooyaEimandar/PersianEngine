...
namespace Debugger
{
    public class DebugCommandUI : IDebugCommandHost
    {
        #region Constants
        ...
        public void Draw(SpriteBatch spriteBatch, SpriteFont font, Texture2D whiteTexture)
        {
            ...
            float w = spriteBatch.GraphicsDevice.Viewport.Width;
            float h = spriteBatch.GraphicsDevice.Viewport.Height;
