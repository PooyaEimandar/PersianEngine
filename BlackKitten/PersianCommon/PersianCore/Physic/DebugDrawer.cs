 ...
 * 
 * File Name        : DebugDrawer.cs
 * File Description : Visualize and debugging Physics
...
namespace PersianCore.Physic
{
    ...
    public class DebugDrawer : IDebugDrawer
    {
        ...
        public void DrawLine(JVector p0, JVector p1, Color color)
        {
            ...
            LineList[lineIndex - 2].Position = p0.ToXNAVector();

            LineList[lineIndex - 1].Color = color;
            LineList[lineIndex - 1].Position = p1.ToXNAVector();
        }
        ...
        public void DrawTriangle(JVector p0, JVector p1, JVector p2, Color color)
        {
            ...
            TriangleList[triangleIndex - 2].Position = p0.ToXNAVector();

            TriangleList[triangleIndex - 1].Color = color;
            TriangleList[triangleIndex - 1].Position = p1.ToXNAVector();

            TriangleList[triangleIndex - 3].Color = color;
            TriangleList[triangleIndex - 3].Position = p2.ToXNAVector();
        }
