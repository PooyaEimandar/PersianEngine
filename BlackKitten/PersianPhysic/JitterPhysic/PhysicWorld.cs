...
namespace JitterPhysic
{
    ...
    public class PhysicWorld
    {
        ...
        private JitterPhysic.Collision.IslandManager islands = new IslandManager();
        ...
        /// active arbiter in the <see cref="PhysicWorld"/> are stored in this map.
        /// </summary>
        ...
        /// <summary>
        /// Gets a read only collection of the <see cref="JitterPhysic.Collision.CollisionIsland"/> objects managed by
        /// this class.
        /// </summary>
        ...
        /// <summary>
        /// Create a new instance of the <see cref="PhysicWorld"/> class.
        /// </summary>
        ...
        /// </param>
        public PhysicWorld(CollisionSystem collision)
        {
            if (collision == null)
        ...
        /// <summary>
        /// Gets or sets the gravity in this <see cref="PhysicWorld"/>. The default gravity
        /// is (0,-9.81,0)
        /// </summary>
