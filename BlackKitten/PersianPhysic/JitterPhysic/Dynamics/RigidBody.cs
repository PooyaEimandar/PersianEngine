...
using JitterPhysic.DataStructures;
#endregion

namespace JitterPhysic.Dynamics
{
    public enum DrawType : byte
    {
        Solid, WireFrame, DoNotDraw
    }

    public enum RigidBodyIndex : byte
    {
        RigidBody1, RigidBody2
    }

    public enum CollisionTags : byte
    {
        NOP,
        BulletWithStatic
    }
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        public JVector CollisionPosition
        {
            get;
            set;
        }

        public Action<float> PreStepAction = null;
        public Action<float> PostStepAction = null;
        ...
        public RigidBody(Shape shape, Material material, bool isParticle)
        {
            ...
            this.drawType = DrawType.WireFrame;
        ...
        /// the next time <see cref="PhysicWorld.Step"/> is called. The 'impact'
        /// of the force depends on the time it is applied to a body - so
        /// the timestep influences the energy added to the body.
        /// </summary>
        /// <param name="force">The force to add next <see cref="PhysicWorld.Step"/>.</param>
        ...
        /// the timestep influences the energy added to the body.
        /// </summary>
        /// <param name="torque">The torque to add next <see cref="PhysicWorld.Step"/>.</param>
        ...
        {
            if (this.PreStepAction != null)
            {
                this.PreStepAction.Invoke(timestep);
            }
        }

        public virtual void PostStep(float timestep)
        {
            if (this.PostStepAction != null)
            {
                this.PostStepAction.Invoke(timestep);
            }
        }
        ...
        private bool enableDebugDraw = true;
