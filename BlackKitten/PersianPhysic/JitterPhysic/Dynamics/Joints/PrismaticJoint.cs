...
namespace JitterPhysic.Dynamics.Joints
{
    public class PrismaticJoint : Joint
    {
        ...
        public PrismaticJoint(PhysicWorld world, RigidBody body1, RigidBody body2)
            : base(world)
        {
        ...
        public PrismaticJoint(PhysicWorld world, RigidBody body1, RigidBody body2,float minimumDistance, float maximumDistance)
            : base(world)
        {
            fixedAngle = new FixedAngle(body1, body2);
            pointOnLine = new PointOnLine(body1, body2, body1.position, body2.position);
        ...
        public PrismaticJoint(PhysicWorld world, RigidBody body1, RigidBody body2, JVector pointOnBody1,JVector pointOnBody2)
            : base(world)
        {
            fixedAngle = new FixedAngle(body1, body2);
        ...
        public PrismaticJoint(PhysicWorld world, RigidBody body1, RigidBody body2, JVector pointOnBody1, JVector pointOnBody2, float maximumDistance, float minimumDistance)
            : base(world)
        {
            fixedAngle = new FixedAngle(body1, body2);
            pointOnLine = new PointOnLine(body1, body2, pointOnBody1, pointOnBody2);
